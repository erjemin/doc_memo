...
Можно работать с таблицами, колонками, индексами, ключами... и здесь нет аутентификации, но при этом нельзя
одновременно работать нескольким пользователем в режиме "живой доски" (live board). Но самое печальное, в нем нет
никаких инструментов для создания запросов.
